...
namespace GC_LOAM
{
    ...
    struct cloud_info_
    {
        ...
        cloud_info_()
            : header(), startRingIndex(), endRingIndex(), pointColInd(), pointRange(), imuAvailable(0), odomAvailable(0), imuRollInit(0.0), imuPitchInit(0.0), imuYawInit(0.0), initialGuessX(0.0), initialGuessY(0.0), initialGuessZ(0.0), initialGuessRoll(0.0), initialGuessPitch(0.0), initialGuessYaw(0.0), cloud_deskewed(), cloud_corner(), cloud_surface()
        {
        }
        cloud_info_(const ContainerAllocator &_alloc)
            : header(_alloc), startRingIndex(_alloc), endRingIndex(_alloc), pointColInd(_alloc), pointRange(_alloc), imuAvailable(0), odomAvailable(0), imuRollInit(0.0), imuPitchInit(0.0), imuYawInit(0.0), initialGuessX(0.0), initialGuessY(0.0), initialGuessZ(0.0), initialGuessRoll(0.0), initialGuessPitch(0.0), initialGuessYaw(0.0), cloud_deskewed(_alloc), cloud_corner(_alloc), cloud_surface(_alloc)
        {
            (void)_alloc;
        }
...
namespace ros
{
    namespace serialization
    {
        ...
        template <class ContainerAllocator>
        struct Serializer<::GC_LOAM::cloud_info_<ContainerAllocator>>
        {
...
namespace ros
{
    namespace message_operations
    {
        ...
        struct Printer<::GC_LOAM::cloud_info_<ContainerAllocator>>
        {
            ...
            static void stream(Stream &s, const std::string &indent, const ::GC_LOAM::cloud_info_<ContainerAllocator> &v)
            {
                s << indent << "header: ";
                s << std::endl;
